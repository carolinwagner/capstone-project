...
context('Bylawstext', () => {
  ...
  it('shows the users answers in the generated bylaws text', () => {
    ...
    //Paragraph 6
    cy.get('#members').contains('Personengesellschaften')
    cy.get('#members').contains('schriftlich')
    ...
    //Paragraph 9
    cy.get('#memberMeeting').contains(
      'Entlastung des Vorstandes und den Haushaltsplan'
    )
    cy.get('#memberMeeting').contains('per E-Mail')
    cy.get('#memberMeeting').contains('30')
    cy.get('#memberMeeting').contains(
    ...
    //Paragraph 10
    cy.get('#boardComposition').contains(
      'zwei Vorsitzenden und dem Schatzmeister'
    )
    cy.get('#boardComposition').contains('drei Jahren')
    cy.get('#boardComposition').contains('Wiederwahl ist möglich')
